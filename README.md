...
PandaGPT, the first AI foundation model capable of following instructions using data across six modalities （1. image/video; 2. audio; 3. text; 4. depth; 5. heat map; and 6. IMU).
