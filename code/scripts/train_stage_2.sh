...
deepspeed --include localhost:0,1,2,3,4,5,6,7 --master_addr 127.0.0.1 --master_port 28457 train_sft.py \
    ...
    --delta_ckpt_path  ./ckpt/vicuna_7b_v0_peft/stage_1/pytorch_model.pt\
    --max_tgt_len 512\
    --save_path  ./ckpt/vicuna_7b_v0_peft/stage_2/\
    --log_path ./ckpt/vicuna_7b_v0_peft/stage_2/log_rest/
